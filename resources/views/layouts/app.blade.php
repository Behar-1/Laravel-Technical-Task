        ...
        <aside class="w-64 bg-white dark:bg-gray-800 shadow-md flex-shrink-0">
            <div class="p-6">
                ...
                <nav class="space-y-2">
                    ...
                    <a href="{{ route('issues.index') }}" class="block px-4 py-2 rounded hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-800 dark:text-gray-200">Issues</a>
                    <a href="{{ route('tags.index') }}" class="block px-4 py-2 rounded hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-800 dark:text-gray-200">Tags</a>
